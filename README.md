...
2. Launch the backend API and Live Dashboard natively via Docker:
...
2. The Dashboard is already running inside the Docker container you started in Step 2! It will render live metrics, funnel charts, and anomaly alerts dynamically as the AI pipeline runs.
